...
```{r plot-dist, fig.width = 5, fig.height = 4, fig.show="hold", out.width="50%"}
...
```{r plot-ts, fig.width = 5, fig.height = 4, fig.show="hold", out.width="50%"}
hmm$plot_ts("step")
...
```{r plot-tpm, fig.width = 6, fig.height = 4, out.width="70%", fig.align="center"}
...
```{r plot-stat, fig.width = 7, fig.height = 4, out.width="90%", fig.align="center"}
...
```{r hmm-sim-3, results = 'hide', fig.width = 5, fig.height = 4, out.width="60%", fig.align="center"}
...
``` {r hmm-gof, fig.width = 9, fig.height = 3, out.width="100%"}
...
```{r haggis-plot_ts, fig.width = 5, fig.height = 4, fig.show="hold", out.width="50%"}
hmm$plot_ts("step")
